...
Ipopt has built-in Hessian approximation strategy. Figure \ref{fig:nlp_flowchart_chosen} shows which solving methods were implemented and tested.
\begin{figure}[H]
\centering
\begin{tikzpicture}[
  >={Latex[length=2mm]},
...
behavior of the vehicle is more complex, requiring high-order or finer
...
Three tire models were implemented according to section \ref{tiremodel}. Tires have these parameterizations:
\begin{table}[H]
    \centering
    \footnotesize
...
Four vehicles were implemented. The simplest is the single-track Formula Student vehicle, with a static suspension~\ref{staticsusp} and a linear tire~\ref{linearTire}. The controls are the braking force, motor torque, and the steering of the front wheels.
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
        ...
        \midrule
        Wheels                        & 2     & 4     & 4      & 6      \\
        Driven motors                 & 1     & 2     & 1 (shared) & 1 (shared)  \\

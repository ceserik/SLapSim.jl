...
\begin{figure}[H]
    \centering
    \includegraphics{../sync/vehicles/singletrack.png}
    \caption{Singletrack vehicle model.}
...
\begin{figure}[H]
    \centering
    \includegraphics{../sync/vehicles/twintrack.png}
    \caption{Formula Student twintrack vehicle model.}
    \label{fig:vehicle_twintrack}
\end{figure}

\subsection{FormulaE}
This model is implemented according to~\cite{2026ClassProject}.
\begin{figure}[H]
    \centering
    \includegraphics{../sync/vehicles/formula.png}
    \caption{Formula~E vehicle model.}
...
\begin{figure}[H]
    \centering
    \includegraphics{../sync/vehicles/bus.png}
    \caption{Bus vehicle model.}

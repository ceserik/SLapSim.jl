...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
        ...
        Suspension                    & dummy & simple    & quasi-steady & bus 6-wheel \\
        \bottomrule
    \end{tabular}
\end{table}
...
The Formula~E model is implemented according to~\cite{2026ClassProject}.

\begin{figure}[htbp]
    \centering
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includesvg[width=\linewidth]{../sync/vehicles/singletrack.svg}
        \caption{Singletrack}
        \label{fig:vehicle_singletrack}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includesvg[width=\linewidth]{../sync/vehicles/twintrack.svg}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includesvg[width=\linewidth]{../sync/vehicles/formula.svg}
        \caption{Formula~E}
        \label{fig:vehicle_formula}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includesvg[width=\linewidth]{../sync/vehicles/bus.svg}
        \caption{Bus}

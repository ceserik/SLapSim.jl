...
single core. Latter solvers run on CPU, MadNLP solver is able to leverage GPU.
Linear solver are capable of multithreading on CPU, which needs to be explicitly
turned on. Tests were performed on Ryzen 9 9950X and MadNLP ran on Nvidia RTX
5070

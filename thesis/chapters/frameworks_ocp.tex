...
solving of nonlinear program, optional mesh refinment. This chapter decribes framerowks in which the NLP problem can be created and solved. I have stated the theory, these are possible ways to implement the theory
By frameowrk i mean programming language + AD tool + mesh refining
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[
    ...
    \node[block] (def) {1. Problem Transcription};
...
\section{Acados}
Acados is a modular open-source framework for fast embedded optimal control, developed at University of Freiburg~\cite{Verschueren2021}. It has C, Python, MATLAB + Simulink and Octave interface. This framework support generating C code. It is demonstrated by numerous real-world examples, such as drone racing with replanning, robot navigation in cluttered environment and many others \cite{acados_real_world_examples}.

...
\section{GPOPS-II}
GPOPS-II \cite{Patterson2014} is perhaps the most advaced tool for otimal
control, it was developed ad University of Florida by Michael patterson and
Anil V. Rao. other tools allows defininng the problem, but GPOPS-II is a level
higher. It also includes advanced mesh refinement strategies, multiple phase
OCP and automatic scaling. It interaces with MATLAB and C++, uses ADigator
...
interfaces with C++,Python,MATLAB.
...
versatile. Supports Linear programming, quadartic programming, mixed linear programming, Nonlinear programming.
ExaModels \cite{shin2023accelerating} is a specialized algebraic
modelling tool, it utilisies Single instruction, multiple data methods,enabling
derivative evaluation on GPU accelerators. Coupled with MadNLP solver, the
entire computation of nonlinear optimisation can be run on a GPU.

...
Process of solving optimal control problem has 3 parts. Problem definition,
...
interfaces with C++,Python,MATLAB. It provides a framework to build
...
Glenn research center in python for evaluating aircraft concepts. Dymos implelemnts hp mesh refinemnt and Lobatto and radau collocation as default \cite{Falck2021}. According to forum post from julia
...
tool for optimal control, it was developed ad University of Florida by Michael
Patterson and Anil V. Rao. other tools allows defining the problem, but
...
JuMP is the go to tool for algebraic modeling in julia, it is mature,

...
\label{staticsusp}
The static suspension distributes the vehicle's mass and the force from aerodynamics according to the position of the center of gravity and the center of pressure. The underlying equations are
\begin{equation}
    \begin{aligned}
...
This suspension variant takes into account the load transfer caused by longitudinal and lateral accelerations. It is adapted from~\cite{2026ClassProject}, equations are
\begin{equation}
    \begin{aligned}

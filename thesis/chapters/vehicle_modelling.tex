...
Twin-track model has all four tires modeled separately. This captures left-right load transfer. Computational graph of it is shown in figure~\ref{fig:twintrack}
\begin{figure}[H]
	\centering
	\begin{tikzpicture}[

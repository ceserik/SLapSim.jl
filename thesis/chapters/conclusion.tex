...
All goals were achievied. One thing which was not a goal but, would be super useful if i managed to do a validation on real world data. Valdiation of sensitivity analysys. I wanted to do it for a long time but there was not enough of it.
...
At the begging of this project I wanted a more complex model, I wanted to go deepr with cmplexity than my bachelor thesis. That is add pitch, roll and full model of suspension into the simulation. Also this simulation does not account for gearboxes with discrete stages, and no combustion engine.

...
Adjoint methods allow for differentiating the solution of the optimization problem.
In this case it is a function of time, the states and controls along the trajectory, and the car parameters. This is very useful because it greatly simplifies sensitivity
analysis. The traditional way of sensitivity analysis is to compute several runs with
different vehicle parameters, but this allows the sensitivity of all
parameters to be computed in one shot. I am using DiffOpt.jl \cite{besancon2023diffopt}. It is
not exactly an adjoint method, and I do not fully understand how it works. PREFOMRULOVAT TODO TODO TODO

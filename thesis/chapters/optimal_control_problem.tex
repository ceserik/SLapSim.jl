...
\begin{quote}
    ...
    \cite[p.~224]{hairer}
\end{quote}
The article \cite{kelly_traj_opt_video} is an in depth explanation of inner working and implementation  of direct collocation methods, theory here is based on it and on \cite{garg_overview_nodate}.
...
The Gauss-Lobatto family includes both endpoints as collocation points, achieving a quadrature degree of exactness of $2N - 3$. It encompasses widely used schemes such as the trapezoidal and Hermite–Simpson methods. Legendre-Gauss-Lobatto method is formulated using Bucher table of LobattoIIIA methods developed in \cite{ehlePadeApproximationsExponential}.
Then constraints are formulated in classical RK way

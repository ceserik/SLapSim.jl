...
\subsection{gauss radau}
\subsection{gauss lobatto}
\section{comparison of global pseudospectral collocation}
i can tune just polynomial order
\section{comparison of pseudospectral collocation swegmented}
now i can tune polynomial order and number of segments

\section{lavretniev phenomena}
https://arxiv.org/pdf/1909.03326
Sometimes the solution converes to incorrect point, nechapem tomu uplne
\section{comparison of adaptive hp methods}
now i can tune polynomial order and number of segments, and length of individual sewgments
...
runge kutaaa butcher table, show equiavalence between collocation methods and runge kutta methods, show runge kutta methods explicit/implicit, show that they can be used for transcription, tell implicit are better because we have states in future available.
